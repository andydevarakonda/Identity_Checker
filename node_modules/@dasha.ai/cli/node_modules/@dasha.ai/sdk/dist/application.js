    ...
    constructor(options, applicationId, applicationName, instanceId, processingClient, externalTtsClient, instanceStream, inputSchema, outputSchema) {
        ...
        this._handleHttpRequest = async (request) => {
            ...
            try {
                ...
                assert_1.default(typeof parameters.url === "string");
                assert_1.default(parameters.body !== undefined);
                assert_1.default(typeof parameters.method === "string");
                assert_1.default(typeof parameters.headers === "object" && parameters.headers !== null);
                assert_1.default(parameters.requestType === "json" || parameters.requestType === "text");
                assert_1.default(parameters.responseType === "json" || parameters.responseType === "text");
                assert_1.default(typeof parameters.timeout === "number");
                let rawRequestBody;
                if (parameters.body !== null) {
                    rawRequestBody = String(parameters.body);
                    if (parameters.requestType === "json") {
                        (_a = (_d = parameters.headers)["Content-Type"]) !== null && _a !== void 0 ? _a : (_d["Content-Type"] = "application/json");
                        rawRequestBody = JSON.stringify(parameters.body);
                    }
                    if (parameters.requestType === "text") {
                        (_b = (_e = parameters.headers)["Content-Type"]) !== null && _b !== void 0 ? _b : (_e["Content-Type"] = "text/plain");
                    }
                }
                const response = await this.axios.request({
                    method: parameters.method,
                    url: parameters.url,
                    headers: { ...this.axios.defaults.headers, ...parameters.headers },
                    data: rawRequestBody,
