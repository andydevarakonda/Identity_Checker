...
exports.HttpServer = exports.readPostParamsJson = exports.readGetSearchParams = void 0;
...
class HttpServer extends http_1.default.Server {
    ...
    async _requestListener(request, response) {
        var _a;
        if (request.url === undefined || request.method === undefined) {
            return response.writeHead(400).end("Unexpected error: request does not contain url anf method");
        }
        ...
        try {
            ...
            log_1.logAndReturn(this._log, e);
