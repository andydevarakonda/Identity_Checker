...
exports.profilerCommand
    .command("download")
    .option("-i, --appId <string>", "Application id")
    .option("-n, --appName <string>", "Application name")
    .requiredOption("-s, --start <date>", "Start of date range", (v) => new Date(v))
    .option("-c, --createdTime <date>", "Use applications created after this time", (v) => new Date(v))
    ...
    const { appId: applicationId, appName: applicationName, start, end, out, createdTime } = options;
    if ((applicationId === undefined || applicationId === null) && (applicationName === undefined || applicationName === null)) {
        console.error(`Must be defined option '-i(--appId)' or '-n(--appName)' `);
        return;
    }
    if (applicationId !== undefined && applicationId !== null && applicationName !== undefined && applicationName !== null) {
        console.log(`Must be defined one of '-i(--appId)' or '-n(--appName)' `);
        return;
    }
    const request = { start, end, createdTime, applicationId, applicationName };
