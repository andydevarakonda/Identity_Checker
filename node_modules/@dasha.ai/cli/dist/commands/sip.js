...
exports.sipCommand
    ...
    .option("--alias <alias>", "alias for original sip uri, <alias>@<dasha_sip_domain> will be created in addition to existing uri, result sip uri for alias `example`: <example@sip.us.dasha.ai>")
...
exports.sipCommand
    ...
    .option("--alias <alias>", "alias for original sip uri, <alias>@<dasha_sip_domain> will be created in addition to existing uri, result sip uri for alias `example`: <example@sip.us.dasha.ai>")
    .option("--no-alias", "remove alias sip uri")
    .action(async (configName, options) => {
